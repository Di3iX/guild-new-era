...
export const BUILDINGS: BuildingData[] = [
  ...
  },
  {
    id: 'oak-workshop',
    type: 'carpentry',
    name: 'Плотницкая «Дубок»',
    map: { x: 12, y: 4 },
    approach: { x: 12, y: 5 },
    clickZone: { width: 110, height: 88 },
    description: 'Дерево и столярное дело',
    detail:
      'Здесь из досок и железа собирают щиты, ручки и простую утварь. Запах стружки не выветривается никогда.',
  },
];